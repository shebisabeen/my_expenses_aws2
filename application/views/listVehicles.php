                        ...
                        <table id="example1" class="table table-bordered table-striped custom-table">
                            ...
                            <tbody>
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            echo $rowc['status'] == "missing" ? "Missing" : "Recovered";
                                            ?></td>
                                        <td>
                                            <?php
                                            echo date('d-m-Y', strtotime($rowc['missing_date']));
                                            ?></td>
                                        <td>
                                            <div style="display:inline-block; width:45%;text-align:center;">
                                                <form method="post" action="<?php echo base_url(); ?>vehicles/editVehicle">
                            ...
                            <tfoot>
                                <?php if ($this->session->userdata('role') != "guest") { ?>
                                    <button onclick="location.href ='<?php echo base_url(); ?>vehicles/addVehicle';" class="btn btn-block btn-success custom-button-add">Add</button>
                                <?php  } ?>
                            </tfoot>
                        </table>
                    </div>
