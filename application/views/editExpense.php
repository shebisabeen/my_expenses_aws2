            ...
            <section class="content">
                ...
                <div class="box box-default">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-8">
                                <form method="post" action="<?php echo base_url(); ?>expenses/updateExpense" enctype='multipart/form-data'>
                                    <div class="box-body">
                                        <input type="hidden" id="expenseId" name="expenseId" value="<?php
                                                                                                    echo $expenseData['id'];
                                                                                                    ?>">
                                        <div class="form-group">
                                            <label>Title:</label>
                                            <input type="text" class="form-control" name="title" value="<?php echo $expenseData['title']; ?>">
                                        </div>

                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                <label>Type:</label>
                                                <select id="district" name="type" list="type" placeholder="type" class="select-selected">
                                                    <option value="" disabled>Select Type</option>
                                                    <?php foreach ($typesList as $key => $value) { ?>
                                                        <option value="<?php echo $value['name']; ?>" <?php if ($value['name'] == $expenseData['type']) {
                                                                                                            echo "selected";
                                        ...
                                        <div class="form-group">
                                            <label>Amount:</label>
                                            <input type="number" step="0.01" class="form-control" name="amount" value="<?php echo $expenseData['amount']; ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Spent Date:</label>
                                            <input id="datepicker" type="text" class="form-control" name="spent_date" value="<?php echo $expenseData['spent_date']; ?>" required>
                                        </div>
